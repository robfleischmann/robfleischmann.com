    ...
    <footer className="footer text-center text-white-50" id="page-bottom">
        <div className="container">
            <div className="footer-social">
                ...
                <a className="px-3 text-white-50" href="https://github.com/robfleischmann"><i className="fab fa-github fa-2x fa-fw"></i></a>
            </div>
            <div className="footer-copyright">&copy; {new Date().getFullYear()} Rob Fleischmann</div>
        </div>
    </footer>
  );
}
